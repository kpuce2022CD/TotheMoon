...
function EmComments(props){
    ...
    return(
        <div className="emcomments-div">
            ...
            <h3 style={{fontFamily:"NanumGothic",marginLeft:"40px",marginTop:"15px"}}>Comments</h3>
            ...
            <TabContent happyComments={props.happyComments} surprisedComments={props.surprisedComments}
            angerComments={props.angerComments} sadnessComments={props.sadnessComments} neutralComments={props.neutralComments}
            fearComments={props.fearComments} disgustComments={props.disgustComments} clickedTab={clickedTab} 스위치변경={스위치변경}></TabContent>
            </CSSTransition>
